...
%         [best_member, F1] = PSO_EMT(X_train, Y_train,i);
        [best_member, F1] = MT_PSO(X_train, Y_train,i); 
        X_train_best = X_train(:, best_member.position);
        X_test_best = X_test(:, best_member.position);

        % train and predict
        Mdl = fitcknn(X_train_best, Y_train, 'NumNeighbors', 5);
        ...
        for j = 1:num_F1
            ...
            Mdl = fitcknn(X_train_F1, Y_train, 'NumNeighbors', 5);
